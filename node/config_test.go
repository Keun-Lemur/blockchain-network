...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "pract.ipc", false, filepath.Join(os.TempDir(), "pract.ipc")},
		{"data", "pract.ipc", false, "data/pract.ipc"},
		{"data", "./pract.ipc", false, "./pract.ipc"},
		{"data", "/pract.ipc", false, "/pract.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "pract.ipc", true, `\\.\pipe\pract.ipc`},
		{"data", "pract.ipc", true, `\\.\pipe\pract.ipc`},
		{"data", `\\.\pipe\pract.ipc`, true, `\\.\pipe\pract.ipc`},
	}
