...
// NewID calculates the practeum fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the practeum fork ID from an existing chain instance.
