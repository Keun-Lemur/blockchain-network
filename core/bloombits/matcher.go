...
// that address/topic, and binary AND-ing those vectors togpract.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togpract
				var orVector []byte
...
// the requested retrieval queue to be serviced togpract with other sessions.
//
