...
type BlockContext struct {
	...
	// sufficient pract to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers pract from one account to the other
...
// EVM is the practeum Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	Config Config
	// global (to this context) practeum virtual machine
...
func (evm *EVM) CallCode(caller ContractRef, addr common.Address, input []byte, gas uint64, value *big.Int) (ret []byte, leftOverGas uint64, err error) {
	...
	// Fail if we're trying to transfer more than the available balance
	// Note although it's noop to transfer X pract to caller itself. But
