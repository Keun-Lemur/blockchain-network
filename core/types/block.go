...
// Package types contains data types related to practeum consensus.
package types
...
// Header represents a block header in the practeum blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togpract.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the practeum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the practeum
...
// EncodeRLP serializes b into the practeum RLP block format.
