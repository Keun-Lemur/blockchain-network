...
pruning. Remember don't start the Pract without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "pract snapshot prune-state --help" for more details.
`
