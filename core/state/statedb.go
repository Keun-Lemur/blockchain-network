...
// Package state provides a caching layer atop the practeum state trie.
package state
...
// StateDB structs within the practeum protocol are used to store anything
...
//
// Carrying over the balance ensures that Pract doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/practeum-network-network/go-practeum/pull/16485#issuecomment-380438527),
