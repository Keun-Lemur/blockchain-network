...
// It can be used for testing that restart Pract normally.
...
// It can be used for testing that restart Pract after the crash.
...
// Tests a Pract restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Pract was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Pract was crashed and restarts with a broken snapshot. In this case
...
// Tests a Pract was running with snapshot enabled. Then restarts without
...
// Tests the Pract was running with snapshot enabled and resetHead is applied.
...
// Tests the Pract was running with a complete snapshot and then imports a few
