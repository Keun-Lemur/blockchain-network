...
//
// https://github.com/practeum-network-network/go-practeum/pull/15941
...
//
// Details at:
//  - https://github.com/practeum-network-network/go-practeum/issues/18977
//  - https://github.com/practeum-network-network/go-practeum/pull/18988
...
//   with 0.001 pract (thus created but no code)
...
func TestEIP1559Transition(t *testing.T) {
	var (
		...
		addr1   = crypto.PubkeyToAddress(key1.PublicKey)
		addr2   = crypto.PubkeyToAddress(key2.PublicKey)
		funds   = new(big.Int).Mul(common.Big1, big.NewInt(params.Pract))
		gspec   = &Genesis{
