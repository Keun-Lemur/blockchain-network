...
import (
	...
	"github.com/practeum-network-network/go-practeum/internal/jsre"
	"github.com/practeum-network-network/go-practeum/internal/jsre/deps"
	"github.com/practeum-network-network/go-practeum/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute practeum requests through
...
// Welcome show summary of current Pract instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Pract JavaScript console!\n\n"

	// Print some generic Pract metadata
