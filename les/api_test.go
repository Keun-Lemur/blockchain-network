...
import (
	...
	ethdownloader "github.com/practeum-network-network/go-practeum/eth/downloader"
	...
	"github.com/practeum-network-network/go-practeum/p2p/simulations"
	"github.com/practeum-network-network/go-practeum/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	practeum, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, practeum, &config)
	if err != nil {
		return nil, err
	}
	return practeum, nil
