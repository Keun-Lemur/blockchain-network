...
func newClientHandler(ulcServers []string, ulcFraction int, checkpoint *params.TrustedCheckpoint, backend *Lightpracteum) *clientHandler {
...
func (h *clientHandler) handle(p *serverPeer, noInitAnnounce bool) error {
	...
	if err := h.backend.peers.register(p); err != nil {
		p.Log().Error("Light practeum peer registration failed", "err", err)
		return err
	}
