...
import (
	...
	"github.com/practeum-network-network/go-practeum/accounts/abi/bind/backends"
	...
	"github.com/practeum-network-network/go-practeum/contracts/checkpointoracle/contract"
	"github.com/practeum-network-network/go-practeum/core"
	"github.com/practeum-network-network/go-practeum/core/forkid"
	...
	"github.com/practeum-network-network/go-practeum/les/checkpointoracle"
	"github.com/practeum-network-network/go-practeum/les/flowcontrol"
	vfs "github.com/practeum-network-network/go-practeum/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some pract to user1
		...
		case 1:
			...
			// bankUser transfers more pract to user1
		...
		case 2:
			...
			// bankUser transfer some pract to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
