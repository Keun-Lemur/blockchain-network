...
// Package bind generates practeum contract Go bindings.
//
// Detailed usage document and tutorial available on the go-practeum Wiki page:
// https://github.com/practeum-network-network/go-practeum/wiki/Native-DApps:-Go-bindings-to-practeum-contracts
package bind
...
func bindStructTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	case abi.TupleTy:
		...
		// togpract here. The reason is before solidity v0.5.11, kind.TupleRawName
		// is empty, so we use canonical parameter expression to distinguish
		// different struct definition. From the consideration of backward
		// compatibility, we concat these two togpract so that if kind.TupleRawName
