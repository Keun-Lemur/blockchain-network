...
type wizard struct {
	...
	services map[string][]string   // practeum services known to be running on servers
...
// converts it to an practeum address. If an empty line is entered, the default
// value is returned.
