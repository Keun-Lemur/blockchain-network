...
// setting up a new or managing an existing practeum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your practeum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new practeum network down to  |")
	...
	log.Info("Administering practeum network", "name", w.network)
