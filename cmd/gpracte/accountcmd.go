...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage practeum presale wallets",
		ArgsUsage: "",
		Description: `
    pract wallet import /path/to/my/presale.wallet

will prompt for your password and imports your pract presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import practeum presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	pract wallet [options] /path/to/my/presale.wallet
...
between practeum nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    pract account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    pract account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another practeum instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := practConfig{Node: defaultNodeConfig()}
	// Load config file.
