...
import (
	...
	"github.com/practeum-network-network/go-practeum/internal/cmdtest"
	"github.com/practeum-network-network/go-practeum/rpc"
)

type testpract struct {
	*cmdtest.TestCmd
...
func init() {
	// Run the app if we've been exec'd as "pract-test" in runPract.
	reexec.Register("pract-test", func() {
...
// spawns pract with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runPract(t *testing.T, args ...string) *testpract {
	tt := &testpract{}
	...
	// Boot "pract". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("pract-test", args...)
