...
// Package eth implements the practeum protocol.
package eth
...
import (
	...
	"github.com/practeum-network-network/go-practeum/consensus/beacon"
	"github.com/practeum-network-network/go-practeum/consensus/clique"
	...
	"github.com/practeum-network-network/go-practeum/core/state/pruner"
	...
	"github.com/practeum-network-network/go-practeum/eth/protocols/eth"
	"github.com/practeum-network-network/go-practeum/eth/protocols/snap"
	...
	"github.com/practeum-network-network/go-practeum/p2p/dnsdisc"
...
func New(stack *node.Node, config *ethconfig.Config) (*Practeum, error) {
	...
	log.Info("Initialising practeum protocol", "network", config.NetworkId, "dbversion", dbVer)

	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, Pract %s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
