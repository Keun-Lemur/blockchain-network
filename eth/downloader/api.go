...
// Syncing provides information when this nodes starts synchronising with the practeum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  practeum.SyncProgress `json:"status"`
}
