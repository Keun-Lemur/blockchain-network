...
import (
	...
	jsassets "github.com/practeum-network-network/go-practeum/eth/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in go-practeum.
func init() {
	var err error
...
// `enter` and `exit` always go togpract.
