...
# 1. install pract for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for pract
# 5. create pract, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable PRACTEUM_SOCKET
...
!define GROUPNAME "practeum"
!define APPNAME "Pract"
!define DESCRIPTION "Official Go implementation of the practeum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since pract is installed global
