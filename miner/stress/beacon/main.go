...
import (
	...
	"github.com/practeum-network-network/go-practeum/core/beacon"
...
func makeFullNode(genesis *core.Genesis) (*node.Node, *eth.practeum, *ethcatalyst.ConsensusAPI, error) {
	...
	// Create the node and configure a full practeum node on it
...
func makeLightNode(genesis *core.Genesis) (*node.Node, *les.Lightpracteum, *lescatalyst.ConsensusAPI, error) {
	// Define the basic configurations for the practeum node
	datadir, _ := os.MkdirTemp("", "")
