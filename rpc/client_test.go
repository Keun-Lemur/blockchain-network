...
// This test reproduces https://github.com/practeum-network-network/go-practeum/issues/17837 where the
...
// It is the reproducer for https://github.com/practeum-network-network/go-practeum/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-practeum-test-ipc-%d-%d", os.Getpid(), rand.Int63())
