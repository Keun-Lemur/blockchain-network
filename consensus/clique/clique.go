...
// ecrecover extracts the practeum account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the practeum address
...
// practeum testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // practeum address of the signing key
...
// Author implements consensus.Engine, returning the practeum address recovered
