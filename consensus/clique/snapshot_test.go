...
// mapped from textual names used in the tests below to actual practeum private
...
// address retrieves the practeum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the practeum address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/practeum-network-network/go-practeum/issues/17593). Whilst this
