...
// Package graphql provides a GraphQL interface to practeum node data.
package graphql
...
// Account represents an practeum account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an practeum transaction.
...
// Block represents an practeum block.
...
type CallData struct {
	From                 *common.Address // The practeum address the call is from.
	To                   *common.Address // The practeum address the call is to.
...
type SyncState struct {
	progress practeum.SyncProgress
}
