...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte practeum address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an practeum account at a particular block.
    type Account {
    ...
    # Transaction is an practeum transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an practeum account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an practeum account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an practeum block by number or by hash. If neither is
