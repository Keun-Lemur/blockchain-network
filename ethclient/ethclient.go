...
// Package ethclient provides a client for the practeum RPC API.
package ethclient
...
// Client defines typed wrappers for the practeum RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*practeum.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (practeum.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q practeum.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q practeum.FilterQuery, ch chan<- types.Log) (practeum.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q practeum.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg practeum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg practeum.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg practeum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*practeum.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg practeum.CallMsg) (uint64, error) {
...
func toCallArg(msg practeum.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *practeum.SyncProgress {
	if p == nil {
		return nil
	}
	return &practeum.SyncProgress{
