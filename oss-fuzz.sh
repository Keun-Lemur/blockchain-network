...
coverpkg="github.com/practeum-network-network/go-practeum/..."
...
function compile_fuzzer {
  # Inputs:
  # $1: The package to fuzz, within go-practeum
  # $2: The name of the fuzzing function
  # $3: The name to give to the final fuzzing-binary

  path=$GOPATH/src/github.com/practeum-network-network/go-practeum/$1
  func=$2
  fuzzer=$3
